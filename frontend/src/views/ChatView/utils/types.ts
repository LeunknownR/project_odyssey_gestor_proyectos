...
export type CurrentPrivateChatHandler = {
    value: PrivateChatPreview | null;
    fill: (newCurrentChat: PrivateChatPreview) => void;
    clear: () => void;
};
export type CurrentProjectChatHandler = {
    value: ProjectChatPreview | null;
    fill: (newCurrentChat: ProjectChatPreview) => void;
    clear: () => void;
};